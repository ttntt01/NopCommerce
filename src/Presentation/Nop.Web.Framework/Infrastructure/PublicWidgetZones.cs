...
public static partial class PublicWidgetZones
{
    ...
    // Custom branch position
    public static string BranchPosition => "branch_position";
    public static string QuantityPosition => "quantity_position";
    public static string StoreSelection => "store_selection";
    public static string ProductAgentDetails => "agent_details";

    // Custom pre order position

    public static string PreOrderInvoice => "preorderinvoice_position";
}